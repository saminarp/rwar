...
def write_txt(path):
    with open(path, 'w') as wo_title:
        wo_title.writelines(["Page Title\n\n\n",
                             "This is a paragraph\n",
...
class SSGTest(unittest.TestCase):
    ...
    def test_stylesheet_write(self):
        ...
        with open(os.path.join(self.output, 'dist', 'style.css'), 'r', encoding='utf-8') as css:
...
This is another paragraph</p>
        ...
        with open(join(self.output, 'dist', 'Text File.html'), 'r', encoding='utf-8') as html:
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="X-UA-Compatible" content="ie=edge">
<title>dist\Markdown File</title>
<link rel="stylesheet" href="/style.css">
<link rel="stylesheet" href="test-stylesheet-link">
</head>
<body>
<h1>dist\Markdown File</h1>
<div class="content">
...
<li>list item 2</li>
        ...
        with open(join(self.output, 'dist', 'Markdown File.html'), 'r', encoding='utf-8') as html:
            lines = html.readlines()
            actual = ''.join(lines)
...
<li><a href="Text File.html">Text File</a></li><li><a href="Markdown File.html">Markdown File</a></li>
        ...
        with open(join(self.output, 'dist', 'index.html'), 'r', encoding='utf-8') as html:
            lines = html.readlines()
            actual = ''.join(lines)
...
<li><a href="Markdown File.html">Markdown File</a></li>
        ...
        with open(join(self.output, 'dist', 'nested-folder', 'index.html'), 'r', encoding='utf-8') as html:
            lines = html.readlines()
            actual = ''.join(lines)
